    ...
    return (
        ...
        >
            ...
            <div className="flex items-center gap-2">
                    ...
                    <PopoverTrigger asChild onClick={(e) => e.stopPropagation()}>
                        <div className="cursor-pointer" data-testid={`calendar-event-card-startdate-trigger-${task.id}`}>
                            {liveTask.startDate ? (
                                ...
                                <div className="h-6 w-6 rounded-full flex items-center justify-center text-muted-foreground bg-muted hover:bg-muted/80 transition-colors" title="Add start date">
                ...
                {liveTask.startDate && liveTask.endDate && <span className="text-muted-foreground text-xs font-bold">-</span>}
                    ...
                    <PopoverTrigger asChild onClick={(e) => e.stopPropagation()}>
                        <div className="cursor-pointer" data-testid={`calendar-event-card-enddate-trigger-${task.id}`}>
                            {liveTask.endDate ? (() => {
                                ...
                                return dateInfo ? (
                                    <Badge
                                        ...
                                        className={cn(
                                            ...
                                            !dateInfo.isOverdue && !dateInfo.isDueSoon && "bg-muted text-muted-foreground"
                                        )}
                                    >
                                        <CalendarIcon className="h-3 w-3" />
                                ...
                                <div className="h-6 w-6 rounded-full flex items-center justify-center text-muted-foreground bg-muted hover:bg-muted/80 transition-colors" title="Add end date">
                                    <CalendarIcon className="h-4 w-4" />
                                </div>
                            )}
                        </div>
