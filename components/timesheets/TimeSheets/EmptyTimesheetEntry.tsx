    ...
    return (
        <div data-testid="empty-timesheet-container" className="rounded-lg border border-border bg-background">
            ...
            <div className="
                ...
                md:grid-cols-[2fr_3fr_1.5fr_1fr_1fr_1fr_max-content_auto] rounded-t-lg
            ...
            ">
                ...
                <div className="hidden md:block px-4 py-3 border-r order-3">Project</div>
                <div className="hidden md:block px-4 py-3 border-r order-4">Labels</div>
