...
import {
    ...
    ArrowRight, ArrowUpDown, Funnel, Monitor, ArrowUp, ArrowDown, GripVertical,
    ArrowDownAZ, ArrowDownZA, ArrowDown01, ArrowDown10, X
} from 'lucide-react';
import {
  DropdownMenu,
  DropdownMenuContent,
...
export function GanttView({ portfolioId }: GanttViewProps) {
    ...
    const portfolioLeaders = useMemo(() => {
        ...
        const unfilteredProjects = projects.filter((p) => projectIdsVal.includes(p.id!));
    ...
    }, [projects, portfolio?.projects, searchQuery, filterConfig, displayOptions.closedProjects, sortFields]);
