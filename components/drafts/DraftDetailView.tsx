                                ...
                                <div className="flex-1 overflow-y-auto p-4">
                                    <div className="space-y-4">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <div className={cn(
                                                "transition-all duration-400 ease-in-out overflow-hidden space-y-2",
                                                    ...
                                                    <DropdownMenu>
                                                        <DropdownMenuTrigger asChild>
                                                            <Button
                                                                ...
                                                                size="sm"
                                                                className={cn(
                                                                    "h-8 transition-opacity hover:opacity-90 overflow-hidden px-3 rounded-xs flex items-center justify-between gap-2 text-xs font-semibold w-[150px]",
                                                ...
                                                <div className="flex items-center justify-between">
                                                    ...
                                                    <DropdownMenu>
                                                        ...
                                                        <DropdownMenuContent align="end" className="p-2 w-[200px] space-y-1 border-0 border-b-[5px] border-primary">
                                                            <DropdownMenuItem
